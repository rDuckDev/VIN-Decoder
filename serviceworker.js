...
workbox.precaching.precache([
	"/rDuckDev/VIN-Decoder/v1.0.6/",
	"/rDuckDev/VIN-Decoder/v1.0.6/offline/decode.json"
]);
...
workbox.routing.setCatchHandler(({event}) => {
	...
	if (apiURL.test(event.request.url)) return caches.match("/rDuckDev/VIN-Decoder/v1.0.6/offline/decode.json");
});
