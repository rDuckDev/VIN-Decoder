...
workbox.precaching.precache([
	"/rDuckDev/VIN-Decoder/v1.0.11/",
	"/rDuckDev/VIN-Decoder/v1.0.11/offline/decode.json"
]);
...
workbox.routing.setCatchHandler(({event}) => {
	...
	if (apiURL.test(event.request.url)) return caches.match("/rDuckDev/VIN-Decoder/v1.0.11/offline/decode.json");
});
